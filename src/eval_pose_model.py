"""
Evaluate a trained pose-based model on the test set.

Same outputs as the other eval scripts.

Usage (from final_project/):
    python src/eval_pose_model.py
    python src/eval_pose_model.py --run_name pose_v2
"""
...
from train_pose_model import PoseLSTM
...
def main():
    ...
    ds = BasketballPoseDataset(splits_dir / f"{args.split}.csv", pose_dir, augment=False)
